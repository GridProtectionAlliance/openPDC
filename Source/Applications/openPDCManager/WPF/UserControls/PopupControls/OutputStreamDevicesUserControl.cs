...
namespace openPDCManager.UserControls.PopupControls
{
    public partial class OutputStreamDevicesUserControl
    {
        ...
        void GetOutputStreamDeviceList()
        {
            try
            {
                ListBoxOutputStreamDeviceList.ItemsSource = CommonFunctions.GetOutputStreamDeviceList(m_sourceOutputStreamID, false);
            }
            catch (Exception ex)
            {
                CommonFunctions.LogException("GetOutputStreamDeviceList", ex);
        ...
        void SaveOutputStreamDevice(OutputStreamDevice outputStreamDevice, bool isNew, string originalAcronym)
        {
            ...
            try
            {
                string result = CommonFunctions.SaveOutputStreamDevice(outputStreamDevice, isNew, originalAcronym);
            ...
            {
                CommonFunctions.LogException("SaveOutputStreamDevice", ex);
        ...
        void DeleteOutputStreamDevice(int outputStreamID, ObservableCollection<string> devicesToBeDeleted)
        {
            ...
            try
            {
                string result = CommonFunctions.DeleteOutputStreamDevice(outputStreamID, new List<string>(devicesToBeDeleted));
                sm = new SystemMessages(new Message() { UserMessage = result, SystemMessage = string.Empty, UserMessageType = MessageType.Success },
                        ButtonType.OkOnly);
                GetOutputStreamDeviceList();
            }
            ...
            {
                CommonFunctions.LogException("DeleteOutputStreamDevice", ex);
