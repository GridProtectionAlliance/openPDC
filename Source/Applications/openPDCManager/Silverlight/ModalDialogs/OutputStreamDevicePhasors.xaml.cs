...
namespace openPDCManager.ModalDialogs
{
	public partial class OutputStreamDevicePhasors : ChildWindow
	{
		...
		public OutputStreamDevicePhasors(int outputStreamDeviceID, string outputStreamDeviceAcronym)
		{
            ...
            UserControlOutputStreamDevicePhasorsUserControl.m_sourceOutputStreamDeviceID = outputStreamDeviceID;
            UserControlOutputStreamDevicePhasorsUserControl.m_sourceOutputStreamDeviceAcronym = outputStreamDeviceAcronym;						
		}
