...
namespace openPDC.UI.UserControls
{
    ...
    public partial class HistorianViewUserControl : UserControl
    {
        ...
        private ICollection<System.Windows.Controls.MenuItem> m_contextMenuItems;
        ...
        public HistorianViewUserControl()
        {
            ...
            m_contextMenuItems = new List<System.Windows.Controls.MenuItem>();
            ...
            private void InitializeChartWindow()
        {
            if (m_chartWindow == null)
            {
                ...
                m_chartWindow.Unloaded += new RoutedEventHandler(m_chartWindow_Unloaded);          //+=  ChildWindow_Closing;
        ...
        private System.Windows.Controls.MenuItem CreateContextMenuItem(string header, bool isChecked)
        {
        ...
        private void DataGridCheckBoxCheckedChanged(System.Windows.Controls.DataGridCell cell, bool isChecked)
        {
        ...
        {
            System.Windows.Controls.TextBox numericTextBox = sender as System.Windows.Controls.TextBox;
        ...
        // Displays the chart window.
        private void ChartResolutionTextBox_KeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
