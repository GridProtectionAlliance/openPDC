...
namespace ConfigurationSetupUtility
{
    ...
    public class SqlServerSetup
    {
        ...
        public void GrantDatabaseAccess(string loginName)
        {
            ...
            ExecuteStatement("IF DATABASE_PRINCIPAL_ID('openPDCAdminRole') IS NULL CREATE ROLE [openPDCAdminRole] AUTHORIZATION [dbo]");
            ExecuteStatement(string.Format("IF DATABASE_PRINCIPAL_ID('{0}') IS NOT NULL AND DATABASE_PRINCIPAL_ID('openPDCAdminRole') IS NOT NULL EXEC sp_addrolemember N'openPDCAdminRole', N'{0}'", loginName));
            ExecuteStatement(string.Format("IF DATABASE_PRINCIPAL_ID('openPDCAdminRole') IS NOT NULL EXEC sp_addrolemember N'db_datareader', N'openPDCAdminRole'"));
            ExecuteStatement(string.Format("IF DATABASE_PRINCIPAL_ID('openPDCAdminRole') IS NOT NULL EXEC sp_addrolemember N'db_datawriter', N'openPDCAdminRole'"));
        }
